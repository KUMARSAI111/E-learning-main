...
?>
							...
							<div class="team team-list clearfix">
								<div class="team-image">
									<img src="gotoep/images/team/ <?php if(isset($ChairmanPic)) echo $ChairmanPic; ?>" alt="Gorle SaiKiran">
								</div>
								<div class="team-desc">
									<div class="team-title"><h4>Gorle SaiKiran</h4><span>Chairman</span></div>
...
?>
						...
						<div class="col-md-6 bottommargin">
							...
							<div class="team team-list clearfix">
								<div class="team-image">
									<img src="gotoep/images/team/<?php if(isset($ceoPic)) echo $ceoPic; ?>" alt="Chinnam Rufas">
								</div>
								<div class="team-desc">
									<div class="team-title"><h4>Chinnam Rufas</h4><span>CEO</span></div>
